<?php
//to add this to your theme, rename it page-meeting-guide.php and create a fake page called 'Meeting Guide'
//this expects your meetings are saved as recurring events in the WordPress plugin The Events Calendar
