...
`hgol` is an optional string and should be a [Homegroup Online](https://homegroup.online) group code, such as `tbc` [in this example](https://donate.homegroup.online/tbc/). This is understood to be the address for 7th Tradition contributions to the meeting, and not any other entity.
